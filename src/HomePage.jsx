...
const PLANS = [
  {
    ...
    features: {
      ...
      analytics: 'Full', support: 'WhatsApp',
    },
  },
  {
  ...
  },
  {
    ...
    features: {
      ...
      analytics: 'Full', support: 'Email + Chat',
    },
  },
  {
    ...
    features: {
      ...
      deliveryBoys: true, paymentStatus: true, revenueDashboard: true,
      adminCoupons: true, multiBranch: true,
      analytics: 'Full + Reports', support: 'Priority + Call',
    },
  },
];
const FEAT_LABELS = [
  ...
  { key: 'adminOrder',       label: 'Admin Order',       icon: Receipt },
