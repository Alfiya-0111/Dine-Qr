...
const PLAN_FEATURES = {
  ...
  growth: {
    tableManagement: false,  // ❌ Growth mein nahi hai
    name: "Growth",
  },
  pro: {
    tableManagement: true,
    ...
    return (
      <>
        <style>{`
          ...
          .tm-locked-btn {
            padding: 14px 28px;
            background: linear-gradient(135deg, ${MAROON} 0%, #f18e49 100%);
            color: #fff;
            border: none;
            border-radius: 14px;
            font-size: 15px;
          ...
          .tm-locked-btn:hover { opacity: 0.9; transform: translateY(-1px); }
          .tm-locked-features {
            background: #faf9f7;
            border-radius: 14px;
            padding: 20px;
        ...
        <div className="tm-locked-wrap">
          ...
          <div className="tm-locked-features">
            <div className="tm-locked-feature">
              <span className="tm-locked-check">✓</span>
              <span>Unlimited Table Management</span>
            </div>
            <div className="tm-locked-feature">
              <span className="tm-locked-check">✓</span>
              <span>Table Booking System</span>
            </div>
            <div className="tm-locked-feature">
              <span className="tm-locked-check">✓</span>
