// src/pages/HomePage.jsx — REDESIGNED v4 + Dark/Light Mode Toggle + FULLY RESPONSIVE
// Drop-in replacement. Keep all existing imports/configs in firebaseConfig, hooks, etc.
...
const GLOBAL_CSS = `
  ...
  :root, [data-theme="light"] {
    ...
    --nav-bg: rgba(247,243,245,0.88);
    --nav-border: rgba(138,36,75,0.12);
    --card-bg: rgba(255,255,255,0.85);
    --card-border: rgba(138,36,75,0.1);
    --section-alt: rgba(138,36,75,0.04);
    --footer-bg: rgba(26,10,16,0.06);
    --badge-bg: rgba(138,36,75,0.1);
    --phone-bg: linear-gradient(160deg, #fff5f8, #fdeef3);
    --phone-border: rgba(138,36,75,0.15);
    ...
    --testimonial-border: rgba(138,36,75,0.1);
    --faq-open-bg: rgba(138,36,75,0.04);
    --faq-open-border: rgba(138,36,75,0.4);
  ...
  [data-theme="dark"] {
    ...
    --phone-bg: linear-gradient(160deg, #1a0f1e, #0d0810);
    ...
    --testimonial-bg: rgba(255,255,255,0.03);
    --testimonial-border: rgba(255,255,255,0.08);
    --faq-open-bg: rgba(138,36,75,0.06);
    --faq-open-border: rgba(138,36,75,0.5);
    ...
    --logo-filter-scrolled: brightness(1);
  }
  ...
  *[style*="animation"] { transition: background-color 0.35s ease, border-color 0.35s ease, color 0.35s ease !important; }
  ...
  .testimonials-swiper .swiper-pagination-bullet {
    background: rgba(138,36,75,0.4) !important;
    transition: all 0.3s ease;
  }
  .testimonials-swiper .swiper-pagination-bullet-active {
    background: var(--maroon) !important;
    width: 24px !important; border-radius: 12px !important;
  }
  @media (max-width: 768px) {
    .swiper-btn-custom { display: none !important; }
  }
  ...
  .theme-toggle:active svg {
    animation: toggle-spin 0.5s ease forwards;
  }
  ...
  /* Nav: hide desktop links on mobile/tablet */
  .nav-desktop-links {
    display: flex;
    align-items: center;
    gap: 32px;
  ...
  /* Phone mockup: smaller on tablet, hidden on tiny screens */
  .hero-phone-wrapper {
    position: relative;
    display: flex;
    justify-content: center;
    animation: fade-up 0.7s ease 0.2s both, float 6s ease-in-out 0.7s infinite;
  }
  @media (max-width: 480px) {
    .hero-phone-wrapper { display: none; }
    .hero-phone-badge-top { display: none !important; }
    .hero-phone-badge-bottom { display: none !important; }
  }
  @media (min-width: 481px) and (max-width: 900px) {
    .hero-phone-inner { width: 240px !important; }
  }
  ...
  @media (max-width: 700px) {
    .demo-points-grid { grid-template-columns: repeat(2, 1fr); }
  }
  @media (max-width: 400px) {
    .demo-points-grid { grid-template-columns: 1fr 1fr; }
  }

  /* How it works: 4-col → 2-col → 1-col */
  .steps-grid {
    display: grid;
    grid-template-columns: repeat(4, 1fr);
    gap: 20px;
  ...
  @media (max-width: 480px) {
    .steps-grid { grid-template-columns: 1fr 1fr; gap: 24px 16px; }
  }

  /* Savings calculator: 2-col → 1-col */
  .calc-grid {
    display: grid;
  ...
  /* Footer bottom: flex-wrap on mobile */
  .footer-bottom {
  ...
  @media (max-width: 640px) {
    ...
    .footer-trust-badges span { font-size: 10px !important; }
  }
  ...
  @media (max-width: 480px) {
    .hero-h1 { letter-spacing: -1.5px; margin-bottom: 14px; }
  }
  ...
  @media (max-width: 480px) {
    .hero-cta-row { flex-direction: column; gap: 10px; margin-bottom: 28px; }
  ...
  /* Pricing popular card lift - reduce on mobile */
  @media (max-width: 1024px) {
    .plan-popular-lift {
  ...
  /* Demo browser mock: reduce padding on mobile */
  @media (max-width: 480px) {
    .demo-browser-inner { padding: 32px 16px !important; }
  }

  /* FAQ: smaller padding on mobile */
  @media (max-width: 480px) {
    .faq-question-text { font-size: 13px !important; }
    .faq-answer { padding-left: 22px !important; }
  }

  /* Floating buttons: adjust position on mobile */
  @media (max-width: 480px) {
    .fab-review { bottom: 84px !important; right: 16px !important; padding: 10px 14px !important; font-size: 12px !important; }
    .fab-whatsapp { bottom: 24px !important; right: 16px !important; width: 46px !important; height: 46px !important; }
  }

  /* Calc plan selector: 4-col always */
  .calc-plan-selector {
    display: grid;
    grid-template-columns: repeat(4, 1fr);
    gap: 6px;
  ...
  /* Nav announcement ticker */
  .ticker-top { display: block; }
  @media (max-width: 480px) {
    .ticker-top { font-size: 11px !important; }
  }
  ...
  /* Savings list: 2-col on mobile for space */
  .savings-list {
    display: flex;
  ...
  @media (max-width: 480px) {
    .hero-trust-badge { font-size: 11px; padding: 5px 12px; margin-bottom: 16px; }
  }
  ...
  @media (max-width: 560px) {
    .modal-inner { border-radius: 20px; }
  }

  /* Plan card: on tablet 2-col layout, popular card no longer floats up */
  @media (max-width: 1024px) {
    .plan-card-wrapper { transform: none !important; }
  }
`;
...
const PLANS = [
  {
    id: 'trial', name: 'Free Trial', price: 0, period: '30 days', icon: '🎁',
      ...
      >
        ...
        {plan.badge && (
          <div style={{
            ...
            fontSize: 10, fontWeight: 800, letterSpacing: 1.5, whiteSpace: 'nowrap',
        ...
        <div style={{
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ fontSize: 38, marginBottom: 8, filter: `drop-shadow(0 0 10px ${plan.accentGlow})` }}>
              {plan.icon}
            </div>
            ...
            {plan.price === 0 ? (
              <div>
                ...
                <div style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'var(--text3)', marginTop: 4 }}>
                  30 din ke liye • No credit card
                </div>
              </div>
            ) : (
              <div>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 2 }}>
                  <span style={{ fontFamily: 'var(--font-display)', fontSize: 16, fontWeight: 600, color: 'var(--maroon)', lineHeight: '46px', verticalAlign: 'top' }}>₹</span>
                  <span style={{ fontFamily: 'var(--font-display)', fontSize: 46, fontWeight: 900, color: 'var(--maroon)', letterSpacing: '-2px', lineHeight: 1 }}>
                    {plan.price}
                  </span>
                </div>
                <div style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'var(--text3)', marginTop: 4 }}>
                  per {plan.period} • cancel anytime
                </div>
              </div>
            )}
          </div>
          ...
          <div style={{ marginBottom: 20 }}>
            {FEAT_LABELS.map(f => (
              <div key={f.key} style={{
                ...
                <span style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'var(--text2)' }}>{f.label}</span>
                <span>
    ...
    const unsub = onValue(tRef, (snap) => {
      ...
      if (data) {
        ...
        setTestimonials([
          ...
          { id: '3', name: 'Amit Patel', role: 'Owner, Gujarat Bhojanalay', location: 'Ahmedabad', text: 'Zomato ke 30% commission se chhutkara! Ab full profit apne paas. Best decision ever.', rating: 5, avatar: 'AP', growth: '₹50K saved' },
      ...
      >
        {testimonials.map(t => (
          <SwiperSlide key={t.id}>
            ...
            >
              <div style={{ position: 'absolute', top: 12, right: 16, fontSize: 80, color: 'rgba(138,36,75,0.08)', fontFamily: 'Georgia', lineHeight: 1, pointerEvents: 'none' }}>"</div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, paddingTop: 16, borderTop: '1px solid var(--glass-border)' }}>
                ...
                <div>
                  ...
                  <div style={{ fontFamily: 'var(--font-body)', fontSize: 11, color: 'var(--text3)', marginTop: 1 }}>📍 {t.location}</div>
                </div>
              </div>
            </div>
          </SwiperSlide>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (form.growthMetric && form.growthValue) {
        const prefix = form.growthMetric === 'savings' ? '₹' : '+';
...
const HomePage = () => {
 ...
 const [footerData, setFooterData] = useState({
  ...
  const demoTabs = {
    orders: { icon: '💬', title: 'WhatsApp Orders', points: ['One-click WhatsApp ordering', 'Auto-generated order messages', 'Real-time voice notifications', 'Zero commission — ever'] },
    dashboard: { icon: '📊', title: 'Revenue Dashboard', points: ['Live sales tracking', 'Top dish analysis', 'Cash vs online split', 'Daily/weekly/monthly view'] },
    kitchen: { icon: '👨‍🍳', title: 'Kitchen Display (KDS)', points: ['Per-order prep timers', 'Spice & salt customization', 'Status progression tracking', 'One-tap order completion'] },
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="India's #1 restaurant QR menu software. Create digital QR code menus, receive WhatsApp orders, manage table bookings & kitchen display. Zero commission. ₹199/month. 30-day free trial." />
      ...
      <div data-theme={theme} style={{ minHeight: '100vh', background: 'var(--dark)', fontFamily: 'var(--font-body)', overflowX: 'hidden' }}>
        ...
        <section className="hero-section">
          {/* Ambient orbs */}
          <div style={{ position: 'absolute', top: '10%', left: '5%', width: isMobile ? 300 : 600, height: isMobile ? 300 : 600, borderRadius: '50%', background: `radial-gradient(circle, ${isDark ? 'rgba(138,36,75,0.18)' : 'rgba(138,36,75,0.09)'} 0%, transparent 65%)`, pointerEvents: 'none' }} />
          <div style={{ position: 'absolute', bottom: '5%', right: '5%', width: isMobile ? 250 : 500, height: isMobile ? 250 : 500, borderRadius: '50%', background: `radial-gradient(circle, ${isDark ? 'rgba(255,209,102,0.07)' : 'rgba(138,36,75,0.05)'} 0%, transparent 65%)`, pointerEvents: 'none' }} />
            ...
            <div className="hero-grid">
              ...
              <div>
                ...
                <h1 className="hero-h1">
                  India's #1<br />
                  <span style={{ background: isDark ? 'linear-gradient(135deg, var(--maroon) 0%, var(--gold) 50%, var(--maroon2) 100%)' : 'linear-gradient(135deg, var(--maroon) 0%, #c47d00 50%, var(--maroon2) 100%)', backgroundSize: '200% auto', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', animation: 'shimmer 3s linear infinite' }}>
                    Restaurant OS
                  </span>
                </h1>
                ...
                <div className="hero-social-proof">
                  ...
                  <div style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'var(--text3)' }}>
                    <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 18, color: 'var(--maroon)' }}>₹0</span> commission
                  </div>
                </div>
              </div>
              ...
              <div className="hero-phone-wrapper hero-phone-col">
                ...
                <div className="hero-phone-inner" style={{ width: 280, background: 'var(--phone-bg)', borderRadius: 32, border: '1px solid var(--phone-border)', overflow: 'hidden', boxShadow: isDark ? '0 40px 100px rgba(0,0,0,0.6)' : '0 40px 80px rgba(138,36,75,0.15)', position: 'relative' }}>
                  ...
                  <div style={{ background: 'linear-gradient(135deg, var(--maroon), var(--maroon2))', padding: '14px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div>
                      <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 15, color: '#fff' }}>Delhi Darbar</div>
                  ...
                  <div style={{ padding: '6px 10px 14px', display: 'flex', flexDirection: 'column', gap: 8 }}>
                    {[
                      { name: 'Butter Chicken', price: '₹280', emoji: '🍗', tag: 'Bestseller', stars: 4.5 },
                      { name: 'Paneer Tikka', price: '₹220', emoji: '🧀', tag: 'Popular', stars: 4.3 },
                    ].map((dish, i) => (
                      <div key={i} style={{ background: 'var(--glass)', border: '1px solid var(--glass-border)', borderRadius: 12, padding: '8px', display: 'flex', gap: 8, alignItems: 'center' }}>
                        <div style={{ width: 46, height: 46, borderRadius: 8, background: 'var(--glass)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, flexShrink: 0 }}>
                          {dish.emoji}
                        </div>
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ display: 'inline-block', background: 'rgba(138,36,75,0.1)', border: '1px solid rgba(138,36,75,0.25)', color: 'var(--maroon)', fontSize: 9, fontWeight: 800, padding: '2px 6px', borderRadius: 100, marginBottom: 3, fontFamily: 'var(--font-display)' }}>
                            {dish.tag}
                          </div>
                ...
                <div className="hero-phone-badge-top" style={{ position: 'absolute', top: 60, right: -16, background: isDark ? 'rgba(15,11,17,0.95)' : 'rgba(255,255,255,0.95)', border: '1px solid var(--glass-border)', borderRadius: 14, padding: '10px 12px', backdropFilter: 'blur(20px)', boxShadow: '0 8px 24px rgba(138,36,75,0.15)', minWidth: 140, animation: 'float2 5s ease-in-out infinite' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontFamily: 'var(--font-body)', fontSize: 10, color: 'var(--text3)' }}>Table 5 · WhatsApp</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="hero-phone-badge-bottom" style={{ position: 'absolute', bottom: 60, left: -16, background: isDark ? 'rgba(15,11,17,0.95)' : 'rgba(255,255,255,0.95)', border: '1px solid var(--glass-border)', borderRadius: 14, padding: '10px 12px', backdropFilter: 'blur(20px)', boxShadow: '0 8px 24px rgba(138,36,75,0.15)', animation: 'float 7s ease-in-out 1s infinite' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <div>
                      <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 13, color: 'var(--maroon)' }}>₹2,450</div>
        ...
        <section ref={countRef} style={{ padding: '40px 0', background: isDark ? 'rgba(255,255,255,0.015)' : 'rgba(138,36,75,0.03)', borderTop: '1px solid var(--glass-border)', borderBottom: '1px solid var(--glass-border)' }}>
          <div className="container">
            <div className="stats-grid">
              {[
                { value: `${restaurantCount}+`, label: 'Restaurants', sub: 'Trust Khaatogo' },
                { value: '₹0', label: 'Commission', sub: 'On All Orders' },
                { value: '50K+', label: 'Orders', sub: 'Processed' },
                { value: '4.9★', label: 'Rating', sub: 'By Owners' },
              ].map((s, i) => (
        ...
        <section id="features" className="section-pad">
          <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 1, background: 'linear-gradient(90deg, transparent, rgba(138,36,75,0.4), transparent)' }} />
          <div className="container">
            <Reveal>
              ...
              <Reveal delay={150}>
                <div style={{ background: 'var(--calc-bg)', border: '1px solid rgba(138,36,75,0.2)', borderRadius: 24, padding: isMobile ? 20 : 28, boxShadow: isDark ? 'none' : '0 8px 32px rgba(138,36,75,0.08)' }}>
                  ...
                  {[
                    ...
                    { label: 'Avg order value', val: avg, setter: setAvg, min: 100, max: 2000, step: 50, fmt: v => `₹${fmt(v)}` },
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <div className="calc-plan-selector">
                      {[{ l: 'Free', v: 0 }, { l: '₹199', v: 199 }, { l: '₹499', v: 499 }, { l: '₹999', v: 999 }].map(p => (
                  ...
                  <div style={{ background: isDark ? 'rgba(0,0,0,0.3)' : 'rgba(138,36,75,0.04)', border: '1px solid var(--glass-border)', borderRadius: 16, padding: 18 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}>
                      ...
                      <span style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 13, color: '#dc2626' }}>−₹{fmt(loss)}</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16, paddingBottom: 16, borderBottom: '1px solid var(--glass-border)' }}>
                      ...
                      <span style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 13, color: '#16a34a' }}>−₹{fmt(planCost)}</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 15, color: 'var(--text1)' }}>Monthly Savings</span>
                      <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: isMobile ? 24 : 30, color: 'var(--maroon)', letterSpacing: '-1px' }}>₹{fmt(saved)}</span>
                    </div>
                  </div>
        ...
        <section id="pricing" className="section-pad">
          <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 800, height: 400, background: 'radial-gradient(ellipse, rgba(138,36,75,0.07) 0%, transparent 65%)', pointerEvents: 'none' }} />
          <div className="container">
            <Reveal>
              <div style={{ textAlign: 'center', marginBottom: 56 }}>
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontSize: 16, color: 'var(--text2)', lineHeight: 1.75, maxWidth: 480, margin: '0 auto' }}>Start free for 30 days. No hidden charges. Cancel anytime. Zero commission — always.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={300}>
              <div style={{ textAlign: 'center', marginTop: 40 }}>
                <p style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--text3)' }}>
                  💡 <strong style={{ color: 'var(--text2)' }}>All plans include:</strong> QR Menu · WhatsApp Orders · Table Booking · Kitchen Display · Analytics · UPI Payments
                </p>
              </div>
            </Reveal>
          </div>
            ...
            <Reveal>
              <div style={{ textAlign: 'center', marginBottom: 40 }}>
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontSize: 16, color: 'var(--text2)', lineHeight: 1.75, textAlign: 'center' }}>
                  Koi aur sawaal hai?{' '}
                  <a href="https://wa.me/916352799072" target="_blank" rel="noreferrer" style={{ color: 'var(--maroon)', textDecoration: 'none', fontWeight: 600 }}>WhatsApp par poochho →</a>
                </p>
              </div>
            </Reveal>
            {faqs.map((f, i) => (
            ...
            <div className="cta-inner" style={{
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'clamp(24px, 4vw, 52px)', color: 'var(--text1)', letterSpacing: '-2px', lineHeight: 1.05, marginBottom: 14 }}>
                  ...
                  <span style={{ background: 'linear-gradient(135deg, var(--maroon), var(--maroon2))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    Saving ₹50K/Month
                  </span>
                </h2>
                <p style={{ fontFamily: 'var(--font-body)', fontSize: 16, color: 'var(--text2)', lineHeight: 1.75, marginBottom: 28, maxWidth: 480, margin: '0 auto 28px' }}>
                  Start your free 30-day trial today. No credit card, no commitment, no commission.
                </p>
                <div className="cta-btn-row">
                  <button onClick={() => navigate('/signup')} style={{
                    background: 'linear-gradient(135deg, var(--maroon), var(--maroon2))',
                    color: '#fff', border: 'none', padding: '15px 32px', borderRadius: 100,
                    fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: isMobile ? 14 : 16, cursor: 'pointer',
                    boxShadow: '0 8px 32px rgba(138,36,75,0.4)', display: 'flex', alignItems: 'center', gap: 10,
                  }}>
                    Start Free 30-Day Trial <ArrowRight style={{ width: 18, height: 18 }} />
                  </button>
