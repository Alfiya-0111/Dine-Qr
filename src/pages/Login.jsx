...
export default function Login() {
  ...
  const login = async () => {
    ...
    try {
      ...
      // ⭐ CHECK: Email verified hai ya nahi
      if (!user.emailVerified) {
        ...
        alert("⚠️ Email not verified!\n\nPlease check your inbox and click the verification link.\n\nIf you didn't receive the email, click 'Resend Verification Email' below.");
        setLoading(false);
        return;
      }
  ...
  const resendVerification = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/too-many-requests') {
        alert("⚠️ Please wait a few minutes before requesting another email.");
      } else {
  ...
  const googleLogin = async () => {
    ...
    try {
      ...
      // No need to check emailVerified
      navigate("/");
